    ...
    <article class="content">
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@DaveAronson",
            bio: `Dave Aronson is a software development consultant with 37 years of experience.
      ...
      >
        Would your tests all still pass if the tested code was changed? If so, you may have test
        gaps, ineffective code, or both! Mutation Testing reveals these cases. This talk will tell
        you all about it.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "Blagoj Jovanov",
            bio: `Blagoj is working as a Senior Software Engineer at Swiss software company Netcetera.
        ...
        socialLinks={[
          {
            type: "linkedin",
            url: "https://www.linkedin.com/in/blagoj-jovanov-2a79b239/",
          },
        ]}
      >
        This is a story which starts with screen capturing, continues with automation of UI
        processes and finally evolves in the art of extreme reverse engineering by the means of
        deep dive into hex code.
      </Talk>
      ...
      <p class="break">45-minutes break</p>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@tijnosaurus",
            bio: `Tijn is a software engineer at Reaktor.
        ...
        socialLinks={[{ type: "github", url: "https://github.com/ams-hackers/gbforth" }]}
      >
        Why read the manual if you can reverse-engineer a ROM instead? This talk shows how you can
        use Forth to learn about retro hardware with an incremental approach.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@davesnx",
            bio: `I'm a Barcelona based software engineer. Trying to make cute software with Reason and OCaml.
      ...
      >
        I will meticulously explain the problem, a few possible solutions and the over-engineered
        approach that I endup with. Frontend, ReScript FFI bindings to JavaScript, and ppxes.
      </Talk>
      ...
      <Talk
        ...
        socialLinks={[]}
      >
        Do you want to quickly share a personal project, a crazy idea, or tell a computer joke?
        Then give a lightning talk at GambiConf! Let us know by sending a <a
          href="https://twitter.com/gambiconf">DM on Twitter</a
        > or telling us during the event.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "Barak Shahino",
            bio: `I'm a big fan of different Medias and a big Sonic The Hedgehog fan.
        ...
        socialLinks={[{ type: "twitter", url: "https://twitter.com/barakshahino" }]}
      >
        I am working on a Sonic 1 ROM hack where I attempt to replicate Klonoa's gameplay
        mechanics in place of Sonic's
      </Talk>
        ...
        speakers={[
          {
            ...
            bio: `Atlas is an independent software engineering firm based in Chicago and Paris.
              Our technological expertise is focused on Common Lisp. Pierre is a partner of Atlas Engineer.`,
          },
        ]}
        speakerImage={`${assets}/speakers/pierre-neidhardt.png`}
        socialLinks={[{ type: "github", url: "https://github.com/Ambrevar" }]}
      >
        Nyxt browser has features that allow you to quickly analyze, navigate, and extract
        information from the web. Plus, Nyxt is fully hackable - all of its source code can be
        introspected, modified, and tweaked.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@theprincessxena",
            bio: `Xe Iaso is the archmage of infrastructure at Tailscale. Xe writes a lot about tech, philosophy and original short stories.
      ...
      >
        Dynamic webapps don't have to be slow. In this talk I will break out how I overengineered
        my blog with Rust to the point that people think it's a static site.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@devmessias",
            bio: `I'm passionate about how we can use computers and math to solve real and abstract problems.
      ...
      >
        Let's talk about how PyASTrX can find messy stuff in your codebase, then discuss a chaotic
        approach using metaprogramming with ASTs to create new behaviors in the sklearn pipelines
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@rlaneth",
            bio: `Laneth dedicates most of his time to the projects of Miralium, his own micro-sized cybersecurity company.
      ...
      >
        Forced to use a SOHO router he was given no permission to manage, Rodrigo Laneth embarks
        on a journey to regain control over his personal network segment.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "@Hilafish1",
            bio: `Hila Fish is a Senior DevOps Engineer at Wix. She believes the DevOps culture is what drives a company to perform in its best,
      ...
      >
        I'll share my journey of migrating an entire R&D's codebase from BitBucket to GitLab on my
        own. you'll gain takeaways you could adopt for your projects!
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "Fernão Vellozo",
            bio: `History teacher who became a sysadmin. GNU/Linux user since 1999, specialist in all sorts of gambiarras and
        ...
        socialLinks={[
          ...
          {
            type: "linkedin",
            url: "https://www.linkedin.com/in/fernaovellozo",
          },
          { type: "facebook", url: "https://www.facebook.com/fernao.vellozo" },
        ]}
      >
        In this talk, we will discuss some tricks and "gambiarras" that are still viable in order
        to extend the lifecycle of firmwares for routers with 4 to 8 MB of flash space and 32 to
        64 MB of RAM.
      </Talk>
      ...
      <Talk
        ...
        speakers={[
          {
            name: "Bruno Francisco",
            bio: `My name is Bruno. I have worked 6 years as a Software Engineer in multiple companies and now I'm focusing on building solutions that are scalable and secure.
        ...
        socialLinks={[
          ...
          {
            type: "linkedin",
            url: "https://www.linkedin.com/in/bfrancisco11/",
          },
          {
            type: "website",
            url: "https://codotto.com/users/fb2ca7cc-0f94-4d6a-a470-0ba4466f6ba7/brunofrancisco",
          },
        ]}
      >
        <a href="https://codotto.com/">Codotto</a> aims to be a platform for IT communities where they
        organize meetups. We'll cover how we built a serverless application that can handle millions
      ...
      <Talk
        ...
        speakers={[
          {
            name: "Lucas Teske",
            bio: `I play, hack stuff, create and destroy stuff. Check it out to see live hacks! Or destroying my computer (it happens).
      ...
      >
        There are tiny machines everywhere in your computer, in your motherboard, your network
        stack, even your fonts. We'll be learning how to make them do our bidding - for fun, of
        course!
      </Talk>
