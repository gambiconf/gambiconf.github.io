	...
	<Window title="Schedule">
		<article class="content">
			...
			>
				...
				processes and finally evolves in the art of extreme reverse engineering by the means of deep
				dive into hex code.
			</Talk>
			...
			<Talk
				...
				socialLinks={[]}
			>
				Do you want to quickly share a personal project, a crazy idea, or tell a computer joke? Then
				give a lightning talk at GambiConf! Let us know by sending a <a
			...
			>
				I am working on a Sonic 1 ROM hack where I attempt to replicate Klonoa's gameplay mechanics
				in place of Sonic's
			</Talk>
			...
			>
				Dynamic webapps don't have to be slow. In this talk I will break out how I overengineered my
				blog with Rust to the point that people think it's a static site.
			</Talk>
			...
			>
				Forced to use a SOHO router he was given no permission to manage, Rodrigo Laneth embarks on
				a journey to regain control over his personal network segment.
			</Talk>
			...
			>
				In this talk, we will discuss some tricks and "gambiarras" that are still viable in order to
				extend the lifecycle of firmwares for routers with 4 to 8 MB of flash space and 32 to 64 MB
				of RAM.
			</Talk>
